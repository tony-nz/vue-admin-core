<template>
  ...
  >
    ...
    >
      <svg v-if="!darkMode" class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
      ...
      <svg v-else class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
