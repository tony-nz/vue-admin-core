...
export default defineComponent({
  ...
  setup(props) {
    ...
    const defaultClass = ref(
      "px-2 py-2 rounded-md dark:hover:bg-gray-600 dark:focus:bg-gray-600 dark:focus:text-white dark:hover:text-white dark:text-white md:mt-0 md:mr-2 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline dark:bg-opacity-40"
    );
