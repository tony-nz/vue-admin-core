<template>
  ...
  >
    <div
      class="flex relative justify-between mr-2 text-gray-500 bg-white hover:bg-gray-400 hover:text-white shadow-lg rounded-lg dark:bg-gray-800 dark:text-gray-400"
    >
      <router-link
        :to="{
          name: item.name,
      ...
      >
        <Duotone
          name="xmark"
          class="fill-black hover:fill-white w-4 h-4"
          aria-hidden="true"
        />
      </button>
    </div>
