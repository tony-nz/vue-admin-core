      ...
      <template #header="slotProps">
        <div class="grid grid-cols-2 gap-4">
          ...
          <div class="flex justify-end">
            <div
              class="flex flex-column md:flex-row md:justiify-content-between mr-2 gap-4 dark:bg-transparent"
            >
              ...
              <button
                ...
                type="button"
                class="bg-primary-500 hover:bg-primary-400 rounded shadow whitespace-nowrap text-white py-2 px-4"
              >
                <span>Create</span>
              </button>
            </div>
          ...
          <div>
            ...
            <div class="-mt-px flex divide-x divide-gray-200">
              <div class="w-0 flex-1 flex">
                <button
                  @click="
                    showCreateEdit('dialog', 'update', (slotProps as any)?.data)
                  "
