...
export default defineComponent({
  ...
  setup(props) {
    ...
    const btnClass = computed(() => {
      return "transition duration-150 ease-in-out btn bg-gray-100 border-gray-800 rounded-lg fill-gray-400 disabled:hover:fill-gray-400 hover:bg-primary-400 disabled:hover:bg-gray-100 dark:bg-slate-800 hover:fill-white p-2 shadow";
    });
    ...
    const btnLockClass = computed(() => {
      return "transition duration-150 ease-in-out btn bg-gray-100 border-gray-800 rounded-lg fill-gray-400 disabled:hover:fill-gray-400 hover:bg-orange-300 hover:fill-white disabled:hover:bg-gray-100 dark:bg-slate-800 p-2 shadow";
    });
